...
function Inp({label,name,value,onChange,placeholder,type="text",rows}){
  return(<div style={{marginBottom:14}}>
    ...
    {rows?<textarea name={name} value={value} onChange={onChange} placeholder={placeholder} rows={rows} style={{width:"100%",padding:"10px 14px",borderRadius:10,border:`1.5px solid ${C.border}`,fontSize:14,fontFamily:"Nunito,sans-serif",outline:"none",background:C.bg,resize:"vertical"}}/>
    :<input name={name} type={type} value={value} onChange={onChange} placeholder={placeholder} style={{width:"100%",padding:"10px 14px",borderRadius:10,border:`1.5px solid ${C.border}`,fontSize:14,fontFamily:"Nunito,sans-serif",outline:"none",background:C.bg}}/>}
  </div>);}
      ...
      <div style={{fontFamily:"Nunito,sans-serif",padding:"22px 24px 24px"}}>
        ...
        <div style={{marginBottom:14}}>
          ...
          <input type="number" min={0} max={100} value={pts} onChange={e=>setPts(Number(e.target.value))}
            style={{width:"100%",padding:"10px 14px",borderRadius:10,border:`1.5px solid ${C.border}`,fontSize:14,fontFamily:"Nunito,sans-serif",outline:"none",background:C.bg}}/>
        </div>
        <div style={{marginBottom:16}}>
    ...
    <div style={{fontFamily:"Nunito,sans-serif"}}>
      ...
      <Card style={{marginBottom:14}}>
        <input value={search} onChange={e=>setSearch(e.target.value)} placeholder="🔍  Search by title or author…"
          style={{width:"100%",padding:"10px 16px",borderRadius:24,border:`1.5px solid ${C.border}`,fontSize:14,fontFamily:"Nunito,sans-serif",outline:"none",background:C.bg,marginBottom:12}}/>
      ...
      {showC&&<div style={{marginTop:10,borderTop:`1px solid ${C.border}`,paddingTop:10}}>
        ...
        <div style={{display:"flex",gap:8,marginTop:6}}>
          ...
          <input value={ct} onChange={e=>setCt(e.target.value)}
            ...
            style={{flex:1,padding:"7px 14px",borderRadius:20,border:`1.5px solid ${C.border}`,fontSize:13,fontFamily:"Nunito,sans-serif",outline:"none",background:C.bg}}/>
        </div>
      </div>}
    </Card>
  );
    ...
    <div style={{fontFamily:"Nunito,sans-serif"}}>
      ...
      <Card style={{marginBottom:14}}>
        <input value={q} onChange={e=>setQ(e.target.value)} placeholder="🔍  Search by name or role…"
          style={{width:"100%",padding:"10px 16px",borderRadius:24,border:`1.5px solid ${C.border}`,fontSize:14,fontFamily:"Nunito,sans-serif",outline:"none",background:C.bg}}/>
      </Card>
...
export default function App(){
  ...
  return(
    <div style={{minHeight:"100vh",background:C.bg,fontFamily:"Nunito,sans-serif"}}>
      ...
      {/* LAYOUT */}
      <div style={{maxWidth:1100,margin:"0 auto",padding:"20px 12px 32px",display:"flex",gap:16}}>

        {/* Left sidebar */}
        <aside className="sl" style={{width:230,flexShrink:0}}>
          <Card style={{marginBottom:12}}>
        ...
        {/* Right sidebar */}
        <aside className="sr" style={{width:255,flexShrink:0}}>
          <Card style={{marginBottom:12}}>
